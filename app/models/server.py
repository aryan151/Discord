...
class Server(db.Model):   
    ...
    #relationships     
    channels = db.relationship('Channel', back_poplulates='server')
    user = db.relationship('User', back_poplulates='servers')   
    serverMembers = db.relationship('ServerMember', back_poplulates='servers')     
